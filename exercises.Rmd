...
### Day 2
 ...
 - [Linear modelling with a single continuous explanatory variable exercise](linear_model_1_exercise.html)
 
 - [Linear modelling with a single categorical explanatory variable exercise](linear_model_2_exercise.html)

\  

### Day 3
 
 - [Linear modelling with continuous and categorical explanatory variables exercise](linear_model_3_exercise.html)
